          ...
          <div className="w-full max-w-md">
            ...
            <form onSubmit={handleSignup} className="space-y-4 sm:space-y-5">
              ...
              <div>
                ...
                <div className="flex min-h-[48px] items-start gap-3 rounded-2xl border border-gray-200 bg-white px-4 py-3 transition focus-within:border-purple-500 focus-within:ring-2 focus-within:ring-purple-200">
